...
{
    /// <summary>
    /// EDSDKLib is a C# Wrapper for Cannon's SDK created by 
    /// 
    /// A C# Wrapper for Canon's SDK written by Johannes Bildstein.  
    /// This is not the production ready version of the EDSDK API project.
    /// For the full version of the EDSDK, checkout
    /// www.fotostein.at/Software/EDSDKAPI
    /// </summary>
    public class SDKHandler : IDisposable
    {
        ...
        /// <summary>
        /// To ensure safe camera communication while live view is on, commands get queued.
        /// </summary>
        private Queue<Action> LvQueue = new Queue<Action>();
        /// <summary>
